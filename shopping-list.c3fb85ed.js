 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const zt=new S(3e4,6e4);function Ft(){const e=Ze().___jsl;if(null==e?void 0:e.H)for(const t of Object.keys(e.H))if(e.H[t].r=e.H[t].r||[],e.H[t].L=e.H[t].L||[],e.H[t].r=[...e.H[t].L],e.CP)for(let t=0;t<e.CP.length;t++)e.CP[t]=null}let Ut=null;function Wt(e){return Ut=Ut||function(e){return new Promise(((t,n)=>{var i,r,o;function s(){Ft(),gapi.load("gapi.iframes",{callback:()=>{t(gapi.iframes.getContext())},ontimeout:()=>{Ft(),n(m(e,"network-request-failed"))},timeout:zt.get()})}if(null===(r=null===(i=Ze().gapi)||void 0===i?void 0:i.iframes)||void 0===r?void 0:r.Iframe)t(gapi.iframes.getContext());else{if(!(null===(o=Ze().gapi)||void 0===o?void 0:o.load)){const t=ht("iframefcb");return Ze()[t]=()=>{gapi.load?s():n(m(e,"network-request-failed"))},dt(`https://apis.google.com/js/api.js?onload=${t}`).catch((e=>n(e)))}s()}})).catch((e=>{throw Ut=null,e}))}(e),Ut}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const jt=new S(5e3,15e3),Ht={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},Bt=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function qt(e){const t=e.config;v(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?N(t,"emulator/auth/iframe"):`https://${e.config.authDomain}/__/auth/iframe`,o={apiKey:t.apiKey,appName:e.name,v:r.SDK_VERSION},s=Bt.get(e.config.apiHost);s&&(o.eid=s);const a=e._getFrameworks();return a.length&&(o.fw=a.join(",")),`${n}?${(0,i.querystring)(o).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class mt extends ue{constructor(e,t,n,i){super(),this.repoInfo_=e,this.onDataUpdate_=t,this.authTokenProvider_=n,this.appCheckTokenProvider_=i,this.log_=I("p:rest:"),this.listens_={}}reportStats(e){throw new Error("Method not implemented.")}static getListenId_(e,t){return void 0!==t?"tag$"+t:((0,s.assert)(e._queryParams.isDefault(),"should have a tag if it's not a default query."),e._path.toString())}listen(e,t,n,i){const r=e._path.toString();this.log_("Listen called for "+r+" "+e._queryIdentifier);const o=mt.getListenId_(e,n),a={};this.listens_[o]=a;const l=ft(e._queryParams);this.restRequest_(r+".json",l,((e,t)=>{let l=t;if(404===e&&(l=null,e=null),null===e&&this.onDataUpdate_(r,l,!1,n),(0,s.safeGet)(this.listens_,o)===a){let t;t=e?401===e?"permission_denied":"rest_error:"+e:"ok",i(t,null)}}))}unlisten(e,t){const n=mt.getListenId_(e,t);delete this.listens_[n]}get(e){const t=ft(e._queryParams),n=e._path.toString(),i=new(0,s.Deferred);return this.restRequest_(n+".json",t,((e,t)=>{let r=t;404===e&&(r=null,e=null),null===e?(this.onDataUpdate_(n,r,!1,null),i.resolve(r)):i.reject(new Error(r))})),i.promise}refreshAuthToken(e){}restRequest_(e,t={},n){return t.format="export",Promise.all([this.authTokenProvider_.getToken(!1),this.appCheckTokenProvider_.getToken(!1)]).then((([i,r])=>{i&&i.accessToken&&(t.auth=i.accessToken),r&&r.token&&(t.ac=r.token);const o=(this.repoInfo_.secure?"https://":"http://")+this.repoInfo_.host+e+"?ns="+this.repoInfo_.namespace+(0,s.querystring)(t);this.log_("Sending REST request for "+o);const a=new XMLHttpRequest;a.onreadystatechange=()=>{if(n&&4===a.readyState){this.log_("REST Response for "+o+" received. status:",a.status,"response:",a.responseText);let e=null;if(a.status>=200&&a.status<300){try{e=(0,s.jsonEval)(a.responseText)}catch(e){T("Failed to parse JSON response for "+o+": "+a.responseText)}n(null,e)}else 401!==a.status&&404!==a.status&&T("Got unsuccessful REST response for "+o+" Status: "+a.status),n(a.status);n=null}},a.open("GET",o,!0),a.send()}))}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class St{constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=xt.OVERWRITE}operationForChild(e){return xe(this.path)?new St(this.source,pe(),this.snap.getImmediateChild(e)):new St(this.source,ye(this.path),this.snap)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Nt{constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=xt.MERGE}operationForChild(e){if(xe(this.path)){const t=this.children.subtree(new fe(e));return t.isEmpty()?null:t.value?new St(this.source,pe(),t.value):new Nt(this.source,pe(),t)}return(0,s.assert)(me(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Nt(this.source,ye(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let xn,kn;function Cn(e,t,n,i){const r=t.source.queryId;if(null!==r){const o=e.views.get(r);return(0,s.assert)(null!=o,"SyncTree gave us an op for an invalid query."),bn(o,t,n,i)}{let r=[];for(const o of e.views.values())r=r.concat(bn(o,t,n,i));return r}}function In(e,t){let n=null;for(const i of e.views.values())n=n||_n(i,t);return n}class Sn{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Mt(null),this.pendingWriteTree_={visibleWrites:zt.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Nn(e,t,n,i,r){return function(e,t,n,i,r){(0,s.assert)(i>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===r&&(r=!0),e.allWrites.push({path:t,snap:n,writeId:i,visible:r}),r&&(e.visibleWrites=Ft(e.visibleWrites,t,n)),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i,r),r?An(e,new St({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function Tn(e,t,n=!1){const i=function(e,t){for(let n=0;n<e.allWrites.length;n++){const i=e.allWrites[n];if(i.writeId===t)return i}return null}(e.pendingWriteTree_,t);if(Kt(e.pendingWriteTree_,t)){let t=new Mt(null);return null!=i.snap?t=t.set(pe(),!0):z(i.children,(e=>{t=t.set(new fe(e),!0)})),An(e,new It(i.path,t,n))}return[]}function En(e,t,n){return An(e,new St({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function Rn(e,t,n,i){const r=Dn(e,i);if(null!=r){const i=Mn(r),o=i.path,s=i.queryId,a=ke(o,t);return zn(e,o,new St(Ct(s),a,n))}return[]}function Ln(e,t,n){const i=e.pendingWriteTree_,r=e.syncPointTree_.findOnPath(t,((e,n)=>{const i=In(n,ke(e,t));if(i)return i}));return Zt(i,t,r,n,!0)}function An(e,t){return On(t,e.syncPointTree_,null,Gt(e.pendingWriteTree_,pe()))}function On(e,t,n,i){if(xe(e.path))return Pn(e,t,n,i);{const r=t.get(pe());null==n&&null!=r&&(n=In(r,pe()));let o=[];const s=me(e.path),a=e.operationForChild(s),l=t.children.get(s);if(l&&a){const e=n?n.getImmediateChild(s):null,t=an(i,s);o=o.concat(On(a,l,e,t))}return r&&(o=o.concat(Cn(r,e,i,n))),o}}function Pn(e,t,n,i){const r=t.get(pe());null==n&&null!=r&&(n=In(r,pe()));let o=[];return t.children.inorderTraversal(((t,r)=>{const s=n?n.getImmediateChild(t):null,a=an(i,t),l=e.operationForChild(t);l&&(o=o.concat(Pn(l,r,s,a)))})),r&&(o=o.concat(Cn(r,e,i,n))),o}function Dn(e,t){return e.tagToQueryMap.get(t)}function Mn(e){const t=e.indexOf("$");return(0,s.assert)(-1!==t&&t<e.length-1,"Bad queryKey."),{queryId:e.substr(t+1),path:new fe(e.substr(0,t))}}function zn(e,t,n){const i=e.syncPointTree_.get(t);(0,s.assert)(i,"Missing sync point for query tag that we're tracking");return Cn(i,n,Gt(e.pendingWriteTree_,t),null)}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class di{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function hi(e,t){let n=null;for(let i=0;i<t.length;i++){const r=t[i],o=r.getPath();null===n||Ce(o,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:o}),n.events.push(r)}n&&e.eventLists_.push(n)}function fi(e,t,n){hi(e,n),pi(e,(e=>Ie(e,t)||Ie(t,e)))}function pi(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const r=e.eventLists_[i];if(r){t(r.path)?(mi(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function mi(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();w&&C("event: "+n.toString()),j(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
